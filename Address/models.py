...
class AddressModel(YGBaseModel):
    ...
    user_id = models.ForeignKey('UserApp.UserModel', on_delete=models.CASCADE, verbose_name='用户', related_name='address')
...
class DiscountModel(YGBaseModel):
    user_id = models.ForeignKey('UserApp.UserModel', on_delete=models.CASCADE, verbose_name='用户', related_name='discount')
    deduction = models.DecimalField(max_digits=2, max_length=10, verbose_name='优惠券额度')
    total_maney = models.DecimalField(max_length=10, max_digits=2, verbose_name='满减额度')
