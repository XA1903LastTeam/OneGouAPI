    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_url', models.CharField(blank=True, max_length=200, null=True, verbose_name='分类图片')),
                ('father_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Funy.CategoryModel', verbose_name='父分类名')),
            ],
            options={
                'verbose_name': '分类表',
